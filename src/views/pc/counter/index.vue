                                ...
                                <div class="input_city_lists" :class="{none:isShow}">
                                    <div class="input_city_lists_header">
                                        <a href="javascript:void(0);"
                                           ...
                                           v-for="(item,index1) in cityListsNew"
                                           :class="{'active_c':num===index1}"
                                           @click="changeCitysTag(index1)"
                                           :key="index1+1"
                                        >
                                            {{item.title}}
                                        </a>
                        ...
                        <FormItem label="户口性质" prop="hukou">
                            <Select v-model="formValidate.hukou"
                                ...
                                <Option :value="item.value"
                                        v-for="(item,index2) in formValidate.hukouLists"
                                        :label="item.label"
                                        :key="index2"
                                ></Option>
                            </Select>
